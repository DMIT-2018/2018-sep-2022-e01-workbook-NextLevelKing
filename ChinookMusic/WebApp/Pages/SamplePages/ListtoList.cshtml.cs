...
namespace WebApp.Pages
{
    public class ListtoListModel : PageModel
    {
        ...
        public IActionResult OnPostAddItem()
        {
            ...
            Warmth = _aboutservices.ColorWarmth();
            //default is remain on page if returned datatype is void instead of IActionResult
            //use the data within the lists

            //note if we are not using IActionResult, replace it with void and remove return Page()
